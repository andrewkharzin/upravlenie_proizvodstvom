    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deadline', models.DateField(verbose_name='Срок услуги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address_line1', models.CharField(max_length=100, verbose_name='Адрес (строка 1)')),
                ('address_line2', models.CharField(blank=True, max_length=100, verbose_name='Адрес (строка 2)')),
                ('city', models.CharField(max_length=50, verbose_name='Город')),
                ('state', models.CharField(max_length=50, verbose_name='Регион/область')),
                ('postal_code', models.CharField(max_length=20, verbose_name='Почтовый индекс')),
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='order.customer')),
            ],
            options={
                'verbose_name': 'Адреса доставки плательщиков',
            },
        ),
        migrations.CreateModel(
            name='Shipping',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_cost', models.DecimalField(decimal_places=2, default='10.0', max_digits=10, verbose_name='Начальная стоимость услуги')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name_plural': 'Способы оплат',
            },
        ),
        migrations.CreateModel(
            name='Passport',
